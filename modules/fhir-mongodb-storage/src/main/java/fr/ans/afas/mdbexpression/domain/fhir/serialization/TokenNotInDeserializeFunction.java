...
/**
 * Deserialize a Token not in expression
 *
 * @author Atos
 * @since 1.0.0
 */
public class TokenNotInDeserializeFunction implements DeserializeFunction<Bson> {
    @Override
    public Expression<Bson> process(SearchConfigService searchConfigService, ExpressionFactory<Bson> expressionFactory, ExpressionSerializer<Bson> expressionDeserializer, String val) {
        ...
        return new MongoDbTokenNotInExpression(searchConfigService, fhirSearchPath, system, valueData);
    }
}
