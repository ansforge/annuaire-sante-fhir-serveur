...
public interface DeserializeFunction<T> {
     ...
     * @param expressionDeserializer the expression deserializer
     * @param val                    the serialized version of the expression
     * @return the expression
     */
    Expression<T> process(SearchConfig searchConfig, ExpressionFactory<T> expressionFactory, ExpressionDeserializer<T> expressionDeserializer, String val);
