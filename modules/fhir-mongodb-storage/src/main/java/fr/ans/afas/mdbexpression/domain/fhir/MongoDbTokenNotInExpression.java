...
import fr.ans.afas.fhirserver.search.expression.TokenNotInExpression;
...
public class MongoDbTokenNotInExpression extends TokenNotInExpression<Bson> {
    ...
    public MongoDbTokenNotInExpression(@NotNull SearchConfigService searchConfigService,
