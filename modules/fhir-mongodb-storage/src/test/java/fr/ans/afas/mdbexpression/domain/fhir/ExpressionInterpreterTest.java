...
public class ExpressionInterpreterTest {
    ...
    public void testDateRangePrecisionExpression() {
        ...
        var fhirPath = FhirSearchPath.builder().resource(TestSearchConfigService.FHIR_RESOURCE_NAME).path(TestSearchConfigService.FHIR_RESOURCE_DATE_PATH).build();
        var date = new Date();
        ...
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_YEAR + "', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.YEAR) + "}", result.toString());
        ...
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MONTH + "', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MONTH) + "}", result.toString());
        ...
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_DAY + "', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.DAY) + "}", result.toString());
        ...
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MINUTE + "', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MINUTE) + "}", result.toString());
        ...
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_SECOND + "', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.SECOND) + "}", result.toString());
        ...
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MILLI + "', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MILLI) + "}", result.toString());
    ...
    public void testDateRangePrefixExpression() {
        ...
        mongoDbDateRangeExpression = new MongoDbDateRangeExpression(testSearchConfig, fhirPath, date, TemporalPrecisionEnum.MILLI, prefix);
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MILLI + "', operator='$gt', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MILLI) + "}", result.toString());

        // gte:
        prefix = ParamPrefixEnum.GREATERTHAN_OR_EQUALS;
        mongoDbDateRangeExpression = new MongoDbDateRangeExpression(testSearchConfig, fhirPath, date, TemporalPrecisionEnum.MILLI, prefix);
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MILLI + "', operator='$gte', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MILLI) + "}", result.toString());

        // lt:
        prefix = ParamPrefixEnum.LESSTHAN;
        mongoDbDateRangeExpression = new MongoDbDateRangeExpression(testSearchConfig, fhirPath, date, TemporalPrecisionEnum.MILLI, prefix);
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MILLI + "', operator='$lt', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MILLI) + "}", result.toString());

        // lte:
        prefix = ParamPrefixEnum.LESSTHAN_OR_EQUALS;
        mongoDbDateRangeExpression = new MongoDbDateRangeExpression(testSearchConfig, fhirPath, date, TemporalPrecisionEnum.MILLI, prefix);
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MILLI + "', operator='$lte', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MILLI) + "}", result.toString());

        // ne:
        prefix = ParamPrefixEnum.NOT_EQUAL;
        mongoDbDateRangeExpression = new MongoDbDateRangeExpression(testSearchConfig, fhirPath, date, TemporalPrecisionEnum.MILLI, prefix);
        result = mongoDbDateRangeExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + MongoDbDateRangeExpression.SUFFIX_MILLI + "', operator='$ne', value=" + FhirDateUtils.getTimeInPrecision(date, TemporalPrecisionEnum.MILLI) + "}", result.toString());
        ...
        Assert.assertEquals("And Filter{filters=[Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + "', operator='$gt', value=" + dateMin + "}, Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_DATE_PATH + "', operator='$lt', value=" + dateMax + "}]}", result.toString());
    ...
    public void testReferenceExpression() {
        var expressionContext = new ExpressionContext();
        var fhirPath = FhirSearchPath.builder().resource(TestSearchConfigService.FHIR_RESOURCE_NAME).path(TestSearchConfigService.FHIR_RESOURCE_REFERENCE_PATH).build();
        var id = "FhirResource";
        var type = "123456789";
        ...
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_REFERENCE_PATH + MongoDbReferenceExpression.REFERENCE_DB_SUFFIX + "', value=" + type + "/" + id + "}", result.toString());
        ...
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_REFERENCE_PATH + MongoDbReferenceExpression.ID_DB_SUFFIX + "', value=" + id + "}", result.toString());
    ...
    public void testQuantityExpression() {
        var expressionContext = new ExpressionContext();
        var fhirPath = FhirSearchPath.builder().resource(TestSearchConfigService.FHIR_RESOURCE_NAME).path(TestSearchConfigService.FHIR_RESOURCE_QUANTITY_PATH).build();
        ...
        var result = mongoDbCodingExpression.interpreter(expressionContext);
        Assert.assertEquals("Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_QUANTITY_PATH + "', value=" + quantity + "}", result.toString());
        ...
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_QUANTITY_PATH + "', operator='$lt', value=" + quantity + "}", result.toString());

        // gt
        mongoDbCodingExpression = new MongoDbQuantityExpression(testSearchConfig, fhirPath, quantity, QuantityExpression.Operator.GT);
        result = mongoDbCodingExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_QUANTITY_PATH + "', operator='$gt', value=" + quantity + "}", result.toString());

        // gte
        mongoDbCodingExpression = new MongoDbQuantityExpression(testSearchConfig, fhirPath, quantity, QuantityExpression.Operator.GE);
        result = mongoDbCodingExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_QUANTITY_PATH + "', operator='$gte', value=" + quantity + "}", result.toString());

        // lte
        mongoDbCodingExpression = new MongoDbQuantityExpression(testSearchConfig, fhirPath, quantity, QuantityExpression.Operator.LE);
        result = mongoDbCodingExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_QUANTITY_PATH + "', operator='$lte', value=" + quantity + "}", result.toString());

        // ne
        mongoDbCodingExpression = new MongoDbQuantityExpression(testSearchConfig, fhirPath, quantity, QuantityExpression.Operator.NE);
        result = mongoDbCodingExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_QUANTITY_PATH + "', operator='$ne', value=" + quantity + "}", result.toString());
    ...
    public void testTokenExpression() {
        var expressionContext = new ExpressionContext();
        var fhirPath = FhirSearchPath.builder().resource(TestSearchConfigService.FHIR_RESOURCE_NAME).path(TestSearchConfigService.FHIR_RESOURCE_TOKEN_PATH).build();
    ...
    public void testStringExpression() {
        var expressionContext = new ExpressionContext();
        var fhirPath = FhirSearchPath.builder().resource(TestSearchConfigService.FHIR_RESOURCE_NAME).path(TestSearchConfigService.FHIR_RESOURCE_STRING_PATH).build();
        var string = "Sample";
        ...
        result = mongoDbStringExpression.interpreter(expressionContext);
        Assert.assertEquals("Operator Filter{fieldName='" + TestSearchConfigService.FHIR_RESOURCE_DB_STRING_PATH + MongoDbStringExpression.INSENSITIVE_SUFFIX + "', operator='$eq', value=BsonRegularExpression{pattern='" + Pattern.quote(MongoDbUtils.removeAccentsAndLowerCase(stringWithComplexChars)) + "', options=''}}", result.toString());
    }
