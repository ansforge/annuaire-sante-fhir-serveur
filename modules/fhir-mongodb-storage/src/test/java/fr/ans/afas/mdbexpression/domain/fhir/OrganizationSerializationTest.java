...
public class OrganizationSerializationTest {
     ...
     */
    final SearchConfigService searchConfigService = new CompositeSearchConfigService(List.of(new ASComplexSearchConfig()));
    /**
     ...
     * The use (fhir) of the address of the test organization
     */
    final String ORGANIZATION_1_ADDRESS_LINE = "Line 1";
    /**
     ...
     * The serializer
     */
    final GenericSerializer organizationResourceSerializer = new GenericSerializer(searchConfigService, FhirContext.forR4());
    ...
    public void testDefaultFields() throws IOException {
        ...
        organizationResourceSerializer.serialize(ResourceAndSubResources.builder().resource(getSampleOrganization()).build(), generator, null);
        generator.close();
        ...
        // FIXME Assert.assertEquals(ORGANIZATION_1_LAST_UPDATED.getTime() + TimeZone.getTimeZone(ZoneId.systemDefault()).getRawOffset(), ((Long) jsonContext.read("$." + StorageConstants.INDEX_T_LASTUPDATED)).longValue());
        ...
        Assert.assertEquals(ORGANIZATION_1_ADDRESS_LINE, jsonContext.read("$." + "t_address-line" + "[0]"));
    ...
    private Organization getSampleOrganization() {
        ...
        organization1.addAddress().setCity(ORGANIZATION_1_ADDRESS_CITY).setCountry(ORGANIZATION_1_ADDRESS_COUNTRY).setPostalCode(ORGANIZATION_1_ADDRESS_POSTAL_CODE).setState(ORGANIZATION_1_ADDRESS_STATE).setUse(ORGANIZATION_1_ADDRESS_USE).addLine(ORGANIZATION_1_ADDRESS_LINE);
